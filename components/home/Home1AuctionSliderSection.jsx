...
const getImageUrl = (img) => {
    if (!img) return '/assets/img/home1/auction-img1.jpg';
...
const AuctionCard = ({ auction }) => {
    const { days, hours, minutes, seconds } = useCountdownTimer(auction.endTime);
    
    // Calculate current bid or starting bid
    const price = auction.currentBid > 0 ? auction.currentBid : auction.startingBid;
        ...
        <div className="auction-card">
            <div className="auction-card-img-wrap">
                ...
                <div className="countdown-timer">
                    <ul data-countdown={auction.endTime}>
...
const Home1AuctionSliderSection = () => {
    ...
    useEffect(() => {
        Promise.all([
            apiGet('/auctions?status=live&limit=8'),
            apiGet('/config/home_auction_slider_section')
        ])
            ...
            .catch(err => {
                console.error("Failed to fetch live auctions or config", err);
                setLoading(false);
            });
    }, []);
    ...
    if (loading) {
        return <div className="text-center py-5">Loading Live Auctions...</div>;
    }
            ...
            <div className="container">
                <div className="row mb-50 align-items-center justify-content-between flex-wrap gap-3 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="col-lg-8 col-md-9">
                        <div className="section-title">
                            <h3>{config?.title || "Streaming Auctions"}</h3>
                ...
                <div className="auction-slider-wrap wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    ...
                    <div className="slider-btn-group">
                        <div className="auction-slider-prev slider-btn">
                        ...
                        <div className="auction-slider-next slider-btn">
                            <svg width={9} height={15} viewBox="0 0 9 15" xmlns="http://www.w3.org/2000/svg">
